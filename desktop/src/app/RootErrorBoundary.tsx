    ...
    if (error) {
      return (
        <div className="flex h-screen w-screen flex-col items-center justify-center gap-3 bg-background px-6 text-foreground">
          <p className="text-base font-semibold">OS1 failed to start</p>
          <p className="max-w-md text-center text-sm text-muted-foreground">
            Reload OS1 to try again. If this keeps happening, check that OS1 can
            access website data, then contact support.
          </p>
          <button
            type="button"
